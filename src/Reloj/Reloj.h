...
#define RELOJ_DESCONOCIDO				MENSAJE16
#define VERIFIQUE_PROG_RELOJ_Y_MOVIL   	MENSAJE17
#define VERIFIQUE_PROG_RELOJ			MENSAJE18
#define VERIFIQUE_PROG_MOVIL			MENSAJE19
#define EQUIPO_EN_MODO_PROGRAMACION		MENSAJE20
